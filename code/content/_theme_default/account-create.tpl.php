              ...
              jQuery(document).ready(function() {
	             ...
	             <div class="col-lg-12 col-sm-12">
                  ...
                  <tr>
                   ...
                   <td><select name="timezone" class="form-control">
									 <?php
									 if (!empty($this->TIMEZONES)) {
								     foreach ($this->TIMEZONES AS $k => $v) {
								     ?>
								     <option value="<?php echo $k; ?>"<?php echo ($this->SETTINGS->timezone==$k ? ' selected="selected"' : ''); ?>><?php echo $v; ?></option>
								     <?php
								     }
									 }
								   ?>
                   ...
                   <td><select name="accCountry" class="form-control">
									 <?php
              ...
              <div class="col-lg-12 col-sm-12">
	            ...
	            <div class="col-lg-12 col-sm-12">
                 ...
                 <tr>
                  ...
                  <td><select name="addCountry" class="form-control">
								  <?php
								  if (!empty($this->COUNTRIES)) {
								  foreach ($this->COUNTRIES AS $k => $v) {
								  ?>
                  ...
                  <td><select name="method" class="form-control">
					     ...
					     <div style="text-align:center">
					      <div class="btns-checkout">
						     <button type="button" class="btn btn-primary" onclick="mm_processor('create',this)"><i class="fa fa-check fa-fw"></i> <?php echo $this->TXT[0]; ?></button>
					      </div>
					     </div>
